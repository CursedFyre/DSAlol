...
void insertNode() {
    ...
    if (getLeftChildIndex(index) < MAX_SIZE && tree[getLeftChildIndex(index)] == -1) {
        parentIndex = getLeftChildIndex(index);
    } else if (getRightChildIndex(index) < MAX_SIZE && tree[getRightChildIndex(index)] == -1) {
        parentIndex = getRightChildIndex(index);
    } else {
